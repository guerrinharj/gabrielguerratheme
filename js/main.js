...
const MenuItemProjects = document.querySelector('.projetos')
...
MenuItemProjects.addEventListener('click', () => {

    TweenMax.staggerFromTo('.menu-projects li', 0.2, {x: 10000}, {x: 0, ease: Elastic.easeOut}, 0.2);
...
MenuItemSobre.addEventListener('click', () => {

    TweenMax.staggerFromTo('.sobre-bio', 0.4, {y:1000}, {y:0}, 0.2);
