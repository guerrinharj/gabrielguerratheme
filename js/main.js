...
const menuIts = document.querySelectorAll('.menu-item')
...
menuIts.forEach(mi => {
  mi.addEventListener('click', () => {
    ...
    console.log(mi.classList.contains('projetos'))
    console.log(mi)




    if (mi.classList.contains('projetos')) {



      overlays.style.mixBlendMode = "normal"

    } else {

      overlays.style.mixBlendMode = "difference"
...
VanillaTilt.init(document.querySelectorAll('.wp-post-image'), {
  max: 105,
  speed: 500
})

VanillaTilt.init(document.querySelector('.gg svg path'), {
  max: 105,
  speed: 500
})
